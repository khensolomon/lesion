...
export function createClockUI() {
    ...
    settings.bind('clock-move-enabled', enableRow, 'active', Gio.SettingsBindFlags.DEFAULT);
    ...
    settings.bind('clock-move-enabled', targetRow, 'sensitive', Gio.SettingsBindFlags.DEFAULT);
    targetRow.set_selected(settings.get_enum('clock-target'));
    targetRow.connect('notify::selected', () => settings.set_enum('clock-target', targetRow.selected));
    ...
    settings.bind('clock-move-enabled', placeRow, 'sensitive', Gio.SettingsBindFlags.DEFAULT);
    placeRow.set_selected(settings.get_enum('clock-position'));
    placeRow.connect('notify::selected', () => settings.set_enum('clock-position', placeRow.selected));
    ...
    const multiRow = new Adw.SwitchRow({ title: 'Two-Line Clock', subtitle: 'Time top, Date bottom' });
    settings.bind('clock-multiline', multiRow, 'active', Gio.SettingsBindFlags.DEFAULT);
    formatGroup.add(multiRow);

    const dimRow = new Adw.SwitchRow({ title: 'Dim Separators' });
    settings.bind('clock-dim-separator', dimRow, 'active', Gio.SettingsBindFlags.DEFAULT);
    ...
    modeRow.connect('notify::selected', () => settings.set_enum('clock-format-mode', modeRow.selected));
    ...
    settings.bind('clock-custom-format', formatEntryRow, 'text', Gio.SettingsBindFlags.DEFAULT);
